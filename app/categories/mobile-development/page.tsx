        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Badge variant="outline">6-10 months</Badge>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex items-start space-x-4">
                        <div className="flex-shrink-0">
                          <div className="w-12 h-12 bg-gray-100 rounded-lg flex items-center justify-center group-hover:bg-orange-200 transition-colors">
                      ...
                      <div className="flex-shrink-0">
                        <Button variant="outline" size="sm" className="group-hover:bg-orange-50 group-hover:border-orange-200 group-hover:text-gray-600 transition-colors">
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <Card className="text-center p-6">
              ...
              <h4 className="text-lg font-semibold mb-2">iOS Development</h4>
              <p className="text-gray-600">
